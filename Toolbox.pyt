...
class Utilities(object):
    ...
    def delete(self, url, triggerCollection, token):
        try:
            ...
            self._requests.append(params)
            params = str(params_json).encode()
            request = Request(url,params)
    ...
    def getToken(self, client_id, client_secret):
        ...
        try:
            request = Request("https://www.arcgis.com/sharing/oauth2/token/?" + params)
            #request = urllib2.Request('https://www.arcgis.com/sharing/oauth2/token/?',str(params))
...
class Toolbox(object):
    def __init__(self):
        self.label = "Geotrigger Management"
        self.alias = "Geotrigger Management"
...
class Schema(object):
    def __init__(self):
        ...
        self.label = "Prepare Feature Class or Shapefile For Geotrigger Service"
        self.description = ""
...
class Delete(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Delete Selected Features From Geotrigger Service"
        self.description = ""
        self.canRunInBackground = True
        self.errors = ""
    ...
    def execute(self, parameters, messages):
        ...
        try:
            ...
            success = deleteGeotriggers(inputFile,token)
            if not success:
                raise arcpy.ExecuteError
            return
...
class Update(object):
    def __init__(self):
        self.label = "Update Selected Features In Geotrigger Service"
        self.description = ""
        self.canRunInBackground = True
        self.errors = ""
